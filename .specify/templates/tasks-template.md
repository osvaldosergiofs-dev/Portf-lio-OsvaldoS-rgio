...
- [ ] T004 Read MCP Open Design source-of-truth project and mandatory files (`Portifólio__PRO`, `index.html`, `DESIGN-HANDOFF.md`, `DESIGN-MANIFEST.json`)
- [ ] T005 Extract design tokens/layout references from source design and document mappings
...
- [ ] T006 Record proof of MCP source gate completion before any implementation task
...
- [ ] T012 Define baseline performance budgets and measurement workflow (LCP/CLS/INP)
- [ ] T013 Define baseline accessibility and responsive QA checklist
...
- [ ] TXXX Performance validation (LCP/CLS/INP evidence captured)
- [ ] TXXX Technical SEO validation (metadata, Open Graph, heading hierarchy, alt text)
- [ ] TXXX Accessibility audit (keyboard, focus visibility, semantics, contrast)
- [ ] TXXX Responsive QA (mobile/tablet/desktop, no horizontal overflow)
