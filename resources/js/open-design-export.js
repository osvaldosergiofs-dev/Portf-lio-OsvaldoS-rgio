...
export function initOpenDesignPortfolio() {
    ...
    const projectDetails = {
      cliqueagenda: {
        title: 'CLIQUEAGENDA',
        video: {
          src: '/portfolio-assets/mpcsmkxw-Video-Project-AGENDA.mp4',
      ...
      voucher: {
        ...
        video: {
          src: '/portfolio-assets/mpcszrsq-Video-Project-VOUCHERX.mp4',
    ...
    const extraProjectDetails = {
      ...
      tourism: {
        ...
        video: {
          src: '/portfolio-assets/mpct34x6-Video-Project-GHS.mp4',
